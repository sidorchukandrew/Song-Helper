...
public class ProgressCircleWithInnerTracker extends JPanel
{
	...
	public ProgressCircleWithInnerTracker()
	{
		setOpaque(true);
		setSize(100, 100);
	...
	public void updateProgressOfIndividualConversion(long l)
	{
		individualProgress = (int)l;
	}
